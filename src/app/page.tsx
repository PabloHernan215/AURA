    ...
    <div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-5">
              <Link href="/professionals" className="btn-primary">
                Reservar mi cita
              </Link>
      ...
      <section className="border-y border-ink/8 bg-white/50 py-20">
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="mt-10 grid gap-10 sm:grid-cols-3">
            {[
              { title: 'Elige tu especialista', body: 'Explora perfiles verificados, sus trabajos y reseñas reales de otros clientes.' },
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="grid grid-cols-3 divide-x divide-ink/8 rounded-xl border border-ink/8 bg-white py-8 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-xs uppercase tracking-wide text-stone">Profesionales verificados</p>
          </div>
        </div>
      </section>
      ...
      {featured.length > 0 && (
        <section className="mx-auto max-w-6xl px-5 py-16">
          <div className="flex items-end justify-between">
            ...
            <Link href="/professionals" className="text-sm font-medium text-moss-600 hover:underline">
              Ver todos →
            </Link>
          </div>
      ...
      <section className="bg-ink py-20">
        <div className="mx-auto max-w-2xl px-5 text-center">
          ...
          <Link href="/professionals" className="btn-primary mt-8 inline-flex bg-white text-ink hover:bg-white/90">
            Reservar mi cita
          </Link>
        </div>
      </section>
